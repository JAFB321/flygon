...
// Temp sensor config
IR_Thermometer_Sensor_MLX90614 sensor_temp = IR_Thermometer_Sensor_MLX90614();;   // instantiate an object to drive our sensor
...
void onGET_READS(){
    ...
    if (millis() - tsLastReport > REPORTING_PERIOD_MS && millis() <= remaining_time ){
        ...
        if(pos < 9){
            double temp = sensor_temp.GetObjectTemp_Celsius();
